...
do intervalo temporal considerado, refletindo o caráter sequencial e relativo dessa variável. Porém, há certa variação, incluindo uma queda na densidade de transações em torno
...
Isso é uma captura da dinâmica temporal real do sistema, não sendo
...
"""Fazendo agora uma análise especificamente na variável V17:
